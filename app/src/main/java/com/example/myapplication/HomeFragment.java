...
public class HomeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view,@Nullable Bundle savedInstanceState){
        rvListInfo = view.findViewById(R.id.rv_listinfo);
        rvListInfo.setHasFixedSize(true);
        listInfo.addAll(DataInfo.getListData());
        showRecylerList();
    }

    private void showRecylerList(){
        rvListInfo.setLayoutManager(new LinearLayoutManager(getContext())); //this
        AdapterInfo adapterInfo = new AdapterInfo(getContext()); //this
        adapterInfo.setModelInfos(listInfo);
        rvListInfo.setAdapter(adapterInfo);
    }
}